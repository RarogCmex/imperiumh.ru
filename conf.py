...
BLOG_AUTHOR = "Рева Денис"  # (translatable)
BLOG_TITLE = "Блог Империум Человека"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://imperiumh.ru/"
...
# "/images/foo.jpg"
DEFAULT_PREVIEW_IMAGE = '/apple-touch-icon.png'
...
FRONT_INDEX_HEADER = {
    DEFAULT_LANG: '<p> Здесь нужно будет разместить баннер с данными для сайта </p>'
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "https://comments.imperium.org.ru/"
